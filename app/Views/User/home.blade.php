        ...
        <div class="main-menu">
            ...
            <section class="delivery-address">
                    <p><span>Đặt Ngay</span> <img src="https://img.icons8.com/color/48/motorcycle.png"
                        ...
                        đi</span>
                        <button><a href="{{Route('/')}}">Bắt đầu đặt hàng</a></button>
                    </p>
                </section>
            <section class="banner">
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide"><img src="app/Views/asset/img/buatruavuive.png" alt=""></div>
                      <div class="swiper-slide"><img src="app/Views/asset/img/gahoangkim.png" alt=""></div>
                    </div>
