    ...
    <div class="header">
        <div class="header-left">
            <ul>
                <li><a href="{{Route('/')}}">
                        <img width="100%"
                            src="app/Views/asset/img/logo.png" alt="">
                    </a>
                </li>
                <li><a href="{{Route('/')}}">THỰC ĐƠN</a></li>
        ...
        ?>
            ...
            <?php if($role==2) { ?>
            <li class="form_li"><a href="{{Route('/adhome')}}">Đăng nhập Admin</a></li>
            <?php } ?>
            <li class="form_li"><a href="index.php?act=mybill">Đơn hàng của tôi</a></li>
            <li class="form_li"><a href="{{Route('/dangxuat')}}">Thoát</a></li>
            <li><a href="index.php?act=addtocart"><i class="fa-solid fa-cart-shopping fa-lg"></i></a></li>
            <br>    
        <?php }else { ?>
                <li><a href="{{Route('/login')}}"><i class="fa-solid fa-user icon fa-lg"></i></a></li>
